...
Podemos observar também como é a distribuição das compras ao longo do ano. 
...
O mês com maior volume de compras é o mês de Setembro (9). Interessante notar que o mês de Maio (5) tem um grande volume de compras, já que esse é o mês do dia das mães. 
...
A linha azul é a média total de compras. Podemos observar que alguns dias superam e muito a média de compras. Os dias 19 e 20 Agosto foram os dias em que ocorreu o maior volume de compras
...
2 produtos foram comprados em menos de 4% das compras. Motrando que o padrão de compra desse comércio eletrônico é majoritariamente de 1 produto.  
